namespace ProjectMonitoring.Texts {
    ...
    declare namespace Db {
        ...
        namespace ProjectMonitoring {
            ...
            namespace Classes {
                export const ClassCode: string;
                export const FinalExamCode: string;
                export const Id: string;
                export const IsFinished: string;
                export const MidExamCode: string;
                export const StartDate: string;
                export const SubjectCode: string;
            }

            namespace Posts {
                export const ContentPost: string;
                export const CreateBy: string;
                export const CreateByAddress: string;
                export const CreateByBirthday: string;
                export const CreateByEmail: string;
                export const CreateByName: string;
                export const CreateByPhone: string;
                export const CreateByUserCode: string;
                export const CreateDate: string;
                export const Id: string;
                export const Title: string;
                export const UserClassId: string;
            }
            ...
            namespace SCMs {
                export const Id: string;
                export const ScmLink: string;
                export const ScmTypeId: string;
                export const ScmTypeName: string;
                export const UserClassClassId: string;
                export const UserClassId: string;
                export const UserClassUserId: string;
            }
            ...
            namespace UserClasses {
                export const ClassClassCode: string;
                export const ClassFinalExamCode: string;
                export const ClassId: string;
                export const ClassIsFinished: string;
                export const ClassMidExamCode: string;
                export const ClassStartDate: string;
                export const ClassSubjectCode: string;
                export const Id: string;
                export const UserAddress: string;
                export const UserBirthday: string;
                export const UserEmail: string;
                export const UserId: string;
                export const UserName: string;
                export const UserPhone: string;
                export const UserUserCode: string;
            }
        }
    }
