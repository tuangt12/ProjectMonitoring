        ...
        var UserClassesEditDialog = /** @class */ (function (_super) {
            ...
            function UserClassesEditDialog() {
                ...
                _this.form.ClassId.changeSelect2(function (e) {
                    ...
                    if (classID != null) {
                        var subjectID = ProjectMonitoring.ClassesRow.getLookup().itemById[classID].SubjectId;
                        _this.form.SubjectName.value = ProjectMonitoring.SubjectsRow.getLookup().itemById[subjectID].Name;
                    }
                });
                return _this;
            }
