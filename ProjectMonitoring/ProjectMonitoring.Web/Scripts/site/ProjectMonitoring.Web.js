        ...
        var UserClassesEditDialog = /** @class */ (function (_super) {
            ...
            function UserClassesEditDialog() {
                ...
                _this.form.ClassId.changeSelect2(function (e) {
                    ...
                    if (classID != null) {
                        var subjectCode = ProjectMonitoring.ClassesRow.getLookup().itemById[classID].SubjectCode;
                        _this.form.SubjectName.value = ProjectMonitoring.SubjectsRow.getLookup().itemById[ProjectMonitoring.ClassesRow.getLookup().itemById[classID].SubjectCode].Name;
                    }
                });
                return _this;
            }
