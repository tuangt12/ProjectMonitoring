        ...
        var UserForm = /** @class */ (function (_super) {
            ...
            function UserForm(prefix) {
                ...
                if (!UserForm.init) {
                    ...
                    var w3 = ProjectMonitoring.ProjectMonitoring.UserClassesEditor;
...
(function (ProjectMonitoring_5) {
    ...
    (function (ProjectMonitoring) {
        ...
        (function (PostsRow) {
            ...
            PostsRow.lookupKey = 'dbo.Posts';
            function getLookup() {
                return Q.getLookup('dbo.Posts');
            }
            PostsRow.getLookup = getLookup;
        ...
        var SCMsForm = /** @class */ (function (_super) {
            ...
            function SCMsForm(prefix) {
                ...
                if (!SCMsForm.init) {
                    SCMsForm.init = true;
                    var s = Serenity;
                    var w0 = ProjectMonitoring.SCMsTypeLookupEditor;
                    var w1 = s.StringEditor;
                    var w2 = s.LookupEditor;
...
(function (ProjectMonitoring_11) {
    ...
    (function (ProjectMonitoring) {
        ...
        (function (SCMTypesRow) {
            ...
            SCMTypesRow.lookupKey = 'dbo.SCMsTypes';
            function getLookup() {
                return Q.getLookup('dbo.SCMsTypes');
            }
            SCMTypesRow.getLookup = getLookup;
...
(function (ProjectMonitoring_17) {
    ...
    (function (ProjectMonitoring) {
        ...
        (function (UserClassesRow) {
            ...
            UserClassesRow.nameProperty = 'Name';
...
(function (ProjectMonitoring_27) {
    var ProjectMonitoring;
    (function (ProjectMonitoring) {
        var SCMsTypeLookupEditor = /** @class */ (function (_super) {
            __extends(SCMsTypeLookupEditor, _super);
            function SCMsTypeLookupEditor(container, options) {
                return _super.call(this, container, options) || this;
            }
            // get Key Lookup từ bảng SCMType
            SCMsTypeLookupEditor.prototype.getLookupKey = function () {
                return ProjectMonitoring.SCMTypesRow.lookupKey;
            };
            // chuyển nội dung từ id sang Name
            // Hiển thị dạng tên loại mã nguồn thay vì id
            SCMsTypeLookupEditor.prototype.getItemText = function (item, lookup) {
                return _super.prototype.getItemText.call(this, item, lookup);
            };
            SCMsTypeLookupEditor = __decorate([
                Serenity.Decorators.registerEditor()
            ], SCMsTypeLookupEditor);
            return SCMsTypeLookupEditor;
        }(Serenity.LookupEditorBase));
        ProjectMonitoring.SCMsTypeLookupEditor = SCMsTypeLookupEditor;
    ...
    (function (ProjectMonitoring) {
        var SCMUserNameFormatter = /** @class */ (function () {
            ...
            SCMUserNameFormatter.prototype.format = function (ctx) {
                ...
                var byId = ProjectMonitoring_28.Administration.UserRow.getLookup().itemById;
...
(function (ProjectMonitoring_34) {
    ...
    (function (ProjectMonitoring) {
        var UserClassesEditDialog = /** @class */ (function (_super) {
            ...
            // Thay đổi giao diện
            // Khi đăng nhập với tư cách không phải admin thì sẽ không cho phép nhập/ chỉnh sửa điểm
            UserClassesEditDialog.prototype.updateInterface = function () {
                _super.prototype.updateInterface.call(this);
                // Nếu kiểm tra mà không có quyền admin
                if (!ProjectMonitoring_34.Authorization.hasPermission("Administration:Security")) {
        ...
        }(ProjectMonitoring_34.Common.GridEditorDialog));
...
(function (ProjectMonitoring_35) {
    ...
    (function (ProjectMonitoring) {
        var UserClassesEditor = /** @class */ (function (_super) {
            __extends(UserClassesEditor, _super);
            function UserClassesEditor(container) {
                return _super.call(this, container) || this;
            }
            ...
            UserClassesEditor.prototype.validateEntity = function (row, id) {
                ...
                var sameClass = Q.tryFirst(this.view.getItems(), function (x) { return x.ClassId === row.ClassId; });
                ...
                row.ClassClassCode = ProjectMonitoring.ClassesRow.getLookup()
                    .itemById[row.ClassId].ClassCode;
                // Gán trường SubjectCode của UserClass hiện tại
                row.ClassSubjectCode = ProjectMonitoring.ClassesRow.getLookup()
        ...
        }(ProjectMonitoring_35.Common.GridEditorBase));
