namespace ProjectMonitoring
{
    ...
    { 
        ...
        private static void RunMigrations(string databaseKey)
        {
            ...
            // remove these lines if you want ProjectMonitoring migrations to run on your DB.

     //Bỏ check cấu truc tên Database
            ...
            using (var sw = new StringWriter())
            {
                ...
                var runner = new RunnerContext(announcer)
                {
                    ...
                    Namespace = "ProjectMonitoring.Migrations." + databaseKey + "DB",
                    Timeout = 90
                };
